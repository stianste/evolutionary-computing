...
public class JNIfgeneric {
   ...
   * @return true if all deletions were successful. If a deletion fails, the method stops attempting
   ...
   * @param overwrite if true, any former directories are deleted and recreated, if false and a
   * directory exists at outputPath, nothing is changed and false returned
   * @return true if the directories could be created or if they existed already, false otherwise
   */
